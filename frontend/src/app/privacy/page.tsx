...
export default function Privacy() {
  return (
    <div className="max-w-screen-lg px-5 mx-auto">
      <h1 className="text-center py-6 sm:py-11">プライバシーポリシー</h1>
      <p>本サービスは、利用者の個人情報の取扱いについて、以下のとおりプライバシーポリシー（以下「本ポリシー」といいます。）を定めます。</p>
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第1条（個人情報）</h2>
      <p>「個人情報」とは、個人情報保護法にいう「個人情報」を指すものとし、生存する個人に関する情報であって、当該情報に含まれる氏名・生年月日・住所・電話番号・連絡先その他の記述等により特定の個人を識別できる情報及び容貌・指紋・声紋にかかるデータ、及び健康保険証の保険者番号などの当該情報単体から特定の個人を識別できる情報（個人識別情報）を指します。</p>
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第2条（個人情報の収集方法）</h2>
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第3条（個人情報を収集・利用する目的）</h2>
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第4条（利用目的の変更）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第5条（個人情報の第三者提供）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
        <li className="my-2">
          ...
          <ol className="text-sm sm:text-base list-[lower-alpha] ml-5">
            ...
            <li className="my-2">
              ...
              <ol className="text-sm sm:text-base list-[lower-roman] ml-5">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第6条（個人情報の開示）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
        <li className="my-2">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第7条（個人情報の訂正および削除）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第8条（個人情報の利用停止等）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第9条（プライバシーポリシーの変更）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第10条（お問い合わせ窓口）</h2>
      <p>
        本ポリシーに関するお問い合わせは、
        <Link href="https://forms.gle/K2vM7erf5y8eo8Nr9" className="text-primary pr-1 hover:underline">お問い合わせフォーム</Link>
        からお願いいたします。
      </p>
