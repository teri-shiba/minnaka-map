...
export default function Terms() {
  return (
    <div className="max-w-screen-lg px-5 mx-auto">
      <h1 className="text-center py-6 sm:py-11">利用規約</h1>
      <p>
        この利用規約（以下「本規約」といいます。）は、
        <Link href="https://minnaka-map.com" className="text-primary pr-1 hover:underline">https://minnaka-map.com</Link>
        上で提供するサービス（以下「本サービス」といいます。）の利用条件を定めるものです。登録利用者の皆さま（以下「利用者」といいます。）には、本規約に従って、本サービスをご利用いただきます。
      </p>
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第1条（適用）</h2>
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第2条（利用登録）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第3条（利用者IDおよびパスワードの管理）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
        <li className="my-2">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第4条（利用料金および支払方法）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
        <li className="my-2">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第5条（禁止事項）</h2>
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第6条（本サービスの提供の停止等）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
        <li className="my-2">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第7条（利用制限および登録抹消）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
        <li className="my-2">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第8条（退会）</h2>
      <p>利用者は、運営の定める退会手続により、本サービスから退会できるものとします。</p>
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第9条（保証の否認および免責事項）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
        <li className="my-2">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第10条（サービス内容の変更等）</h2>
      <p>運営者は、利用者への事前の告知をもって、本サービスの内容を変更、追加または廃止することがあり、利用者はこれを承諾するものとします。</p>
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第11条（利用規約の変更）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
        <li className="my-2">
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第12条（個人情報の取扱い）</h2>
      <p>
        運営者は、本サービスの利用によって取得する個人情報については、本サービス「
        <Link href="/privacy" className="text-primary hover:underline">プライバシーポリシー</Link>
        」に従い適切に取り扱うものとします。
      </p>
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第13条（通知または連絡）</h2>
      ...
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第14条（権利義務の譲渡の禁止）</h2>
      <p>利用者は、運営の書面による事前の承諾なく、利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し、または担保に供することはできません。</p>
      <h2 className="sm:text-xl pt-9 sm:pt-p pb-2">第15条（準拠法・裁判管轄）</h2>
      <ol className="text-sm sm:text-base list-decimal pl-5 sm:pl-6">
        <li className="my-2">
